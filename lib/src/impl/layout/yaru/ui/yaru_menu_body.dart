...
class YaruMenuBody extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    return Container(
      ...
      child: ExpansionPanelList( //NOTE - replace for ExpansionPanelList.radio if after build this requires single-selection behavior
        expansionCallback: (int index, bool isExpanded) {
          ref.read(selectedGroupProvider.notifier).state = allGroups[index];
        },
        children: allGroups.map<ExpansionPanel>(
          (Group group) {
